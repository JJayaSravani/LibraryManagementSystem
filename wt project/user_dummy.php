...
<!--add and del table--> <br><br>
<form action="user_dummy.php" method="post">
...
<?php
$bid=$_POST["add_id"];
$rec="INSERT INTO u3 SELECT * FROM books WHERE book_id='$bid';";
$recres=$con->query($rec);
?>
<!--php for delete-->
<?php
$bid=$_POST["del_id"];
$rec="delete FROM u3 WHERE book_id='$bid';";
$recres=$con->query($rec);
?><br><br>
